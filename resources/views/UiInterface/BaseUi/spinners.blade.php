                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body card-buttons">        
                                    ...
                                    <p class="mb-4">Use the border spinners for a lightweight loading indicator.</p>        
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body card-buttons">        
                                    ...
                                    <p class="mb-4">If you don’t fancy a border spinner, switch to the grow spinner. While it doesn’t technically spin, it does repeatedly grow!</p>        
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body card-buttons">        
                                    ...
                                    <p class="mb-4"> Here it is in blue, along with the supported variants.
                                    </p>    
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body card-buttons">        
                                    ...
                                    <p class="mb-4">Use flexbox utilities, float utilities, or text alignment utilities 
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body card-buttons">        
                                    ...
                                    <p class="mb-4">Use <code>flexbox utilities</code>, <code>float utilities</code>, or <code>text alignment</code> utilities to place spinners exactly where you need them in any situation.</p>        
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body card-buttons">        
                                    ...
                                    <p class="mb-4">Add <code>.spinner-border-sm</code> and 
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body card-buttons">        
                                    ...
                                    <p class="mb-4">Use spinners within buttons to indicate an action is currently processing or taking place. 
