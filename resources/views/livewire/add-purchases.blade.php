<div class="row">
    <div class="col-md-12">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">											
                    <div class="input-block mb-3">
                        ...
                        <ul class="form-group-plus css-equal-heights">
                            ...
                            <li>    
                                <a class="btn btn-primary form-plus-btn" href="{{url('add-customer')}}"><i class="fas fa-plus-circle"></i></a>
                            </li>
                        </ul>												
                    </div>									
                </div>
                ...
                <div class="col-lg-12">											
                    <div class="input-block mb-3">
                        ...
                        <ul class="form-group-plus css-equal-heights">
                            ...
                            <li>    
                                <a class="btn btn-primary form-plus-btn" href="{{url('add-products')}}"><i class="fas fa-plus-circle"></i></a>
                            </li>
                        </ul>												
                    </div>									
                </div>
        ...
        <form action="{{url('purchases')}}" class="text-end">
