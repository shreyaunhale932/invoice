                                ...
                                <table class="table table-stripped table-hover datatable">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($purchases as $purchase)
                                            <tr>
                                                <td>{{ $purchase['Id'] }}</td>
                                                <td><a href="{{ url('purchase-details') }}"
                                                        class="invoice-link">{{ $purchase['PurchaseID'] }}</a> </td>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="{{ url('profile') }}" class="avatar avatar-sm me-2"><img
                                                                class="avatar-img rounded-circle"
                                                                src="{{ URL::asset('/public/assets/img/profiles/' . $purchase['Image']) }}"
                                                                alt="User Image"></a>
                                                ...
                                                <td>{{ $purchase['Date'] }}</td>
                                                <td><span
                                                        class="{{ $purchase['Class'] }}">{{ $purchase['Status'] }}</span>
                                                </td>
