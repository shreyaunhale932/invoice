                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ url('invoice-details') }}"
                                                        class="invoice-link">{{ $ticketslist['TicketID'] }}</a>
                                                </td>
                                                ...
                                                <td>{{ $ticketslist['AssignedDate'] }}</td>
                                                <td>{{ $ticketslist['CreatedOn'] }}</td>
                                                <td>{{ $ticketslist['DueDate'] }}</td>
                                                <td>
                                                    <h2 class="table-avatar">
                                                ...
                                                <td>{{ $ticketslist['LastReply'] }}</td>
                                                <td><span
                                                        class="{{ $ticketslist['Class'] }}">{{ $ticketslist['Priority'] }}</span>
                                                </td>
                                                <td><span
                                                        class="{{ $ticketslist['Class1'] }}">{{ $ticketslist['Status'] }}</span>
                                                </td>
